...
| 3.5 | **advisory checks** | `galaxy-tool-lint` | Detect-only IUC best-practice + planemo-parity checks (74; `CheckRule`, `detect_violations`). Read-only LBYL queries. Depends only on tiers 1 + 0.5. |
