...
Usage::
    ...
    uv run python scripts/corpus_check.py validate [--source github|toolshed|combined] \\
...
def _validate_write_stats(
    *,
    ...
    if source == "combined":
        header_para = (
            f"Generated by `scripts/corpus_check.py validate --source combined` on "
        ...
        header_para = (
            f"Generated by `scripts/corpus_check.py validate --source {source}` on "
...
def _fmt_write_stats(
    *,
    ...
    lines: list[str] = [
        ...
        "",
        (
            f"Generated by `scripts/corpus_check.py fmt` on "
