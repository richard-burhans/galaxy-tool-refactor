...
|---|---:|---:|---:|---:|---:|
| GTR001 | 8,623 | 8,622 | 860,945 | 0 | 0 |
| GTR003 | 8,623 | 8,623 | 69,595 | 0 | 0 |
| GTR004 | 8,623 | 1,368 | 2,429 | 0 | 0 |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|
| GTR002 | ReorderParamAttributes | 8,622 | 6,087 | 8,622 | 0 | 0 | 0 | 0 |
| GTR005 | ReorderToolAttributes | 8,622 | 1,019 | 8,622 | 0 | 0 | 0 | 0 |
| GTR006 | FixTypos | 708 | 39 | 708 | 0 | 0 | 669 | 0 |
| GTR007 | UpdateProfile | 8,622 | 7,220 | 8,622 | 0 | 0 | 0 | 0 |
| GTR008 | Upgrade19_01 | 8,622 | 9 | 8,622 | 0 | 0 | 0 | 0 |
| GTR009 | Upgrade24_0 | 8,622 | 1 | 8,622 | 0 | 0 | 0 | 0 |
| GTR010 | Upgrade24_1 | 8,622 | 224 | 8,622 | 0 | 0 | 4 | 0 |
| GTR011 | Upgrade25_1 | 8,622 | 5 | 8,622 | 0 | 0 | 0 | 0 |
| GTR012 | UpgradeToLatest | 8,622 | 7,223 | 8,622 | 0 | 0 | 0 | 0 |
| GTR013 | ReorderToolChildren | 8,622 | 4,652 | 8,622 | 0 | 0 | 0 | 0 |
| GTR014 | FixFromWorkDirWhitespace | 8,622 | 4 | 8,622 | 0 | 0 | 0 | 0 |
| GTR015 | FixOutputFormatInput | 8,622 | 79 | 8,622 | 0 | 0 | 0 | 0 |
| GTR016 | FixInterpreter | 8,622 | 1,143 | 8,622 | 0 | 0 | 0 | 0 |
| GTR017 | NormalizeBooleanValues | 708 | 21 | 708 | 0 | 0 | 687 | 0 |
| GTR018.1 | WrapCommandCdata | 8,622 | 2,771 | 8,622 | 0 | 0 | 0 | 0 |
| GTR019.1 | WrapHelpCdata | 8,622 | 3,243 | 8,622 | 0 | 0 | 0 | 0 |
| GTR020.1 | SingleQuoteCommandVars | 8,622 | 4,020 | 8,622 | 0 | 0 | 0 | 0 |
| GTR035.1 | TrimAttributeWhitespace | 8,622 | 0 | 8,622 | 0 | 0 | 0 | 0 |
| GTR036 | ReplaceOutputElement | 8,622 | 1 | 8,622 | 0 | 0 | 1 | 0 |
| GTR037 | DropRedundantParamName | 8,622 | 332 | 8,622 | 0 | 0 | 0 | 0 |
| GTR089.1 | RepairHelpRst | 8,622 | 54 | 8,622 | 0 | 0 | 0 | 0 |
| GTR092 | ConvertHelpToMarkdown | 8,622 | 806 | 8,622 | 0 | 0 | 0 | 0 |
| GTR093 | Upgrade21_09 | 8,622 | 0 | 8,622 | 0 | 0 | 0 | 0 |
| GTR094 | TokenizeVersion | 8,622 | 76 | 8,622 | 0 | 0 | 0 | 0 |
| GTR096 | FixTestParamQualification | 8,622 | 1,132 | 8,622 | 0 | 0 | 0 | 0 |

## Upgrade discovery (GTR012 `UpgradeToLatest`, isolated)

Post-apply landing profile over the 8,622 eligible tools. A tool below the latest profile (`26.1`) is a sticking point still needing an `upgrade_vN` codemod.

- reached latest (`26.1`): 8,581
- below latest: 41
