...
| joachim-jacob/qualimap_suite (also in github: tools-iuc) | `qualimap_bamqc` | `bamqc.xml` | `f6ffb9aa409e` | [view](https://toolshed.g2.bx.psu.edu/view/joachim-jacob/qualimap_suite) |
| marc-wilkins/samifier | `samifier` | `samifier/samifier.xml` | `66ad014e6975` | [view](https://toolshed.g2.bx.psu.edu/view/marc-wilkins/samifier) |
| phac-nml-galaxy_tools | `bcftools_view` | `tools/bcftools/view/bcftools_view.xml` | `b9a9397b9aa3` | [view](https://github.com/phac-nml/galaxy_tools/blob/b9a9397b9aa3c5b3ff8325386c5920da964abdbd/tools/bcftools/view/bcftools_view.xml) |
| pieterlukasse/prims_metabolomics2 | `metams_lcms_annotate` | `metaMS/metams_lcms_annotate.xml` | `9f03c8587d6b` | [view](https://toolshed.g2.bx.psu.edu/view/pieterlukasse/prims_metabolomics2) |
| pieterlukasse/prims_metabolomics2 | `metams_lcms_pick_and_group` | `metaMS/metams_lcms_pick_and_group.xml` | `9f03c8587d6b` | [view](https://toolshed.g2.bx.psu.edu/view/pieterlukasse/prims_metabolomics2) |
| pieterlukasse/prims_metabolomics2 | `xcms_differential_analysis` | `metaMS/xcms_differential_analysis.xml` | `9f03c8587d6b` | [view](https://toolshed.g2.bx.psu.edu/view/pieterlukasse/prims_metabolomics2) |
| pieterlukasse/prims_metabolomics2 | `xcms_get_alignment_eic` | `metaMS/xcms_get_alignment_eic.xml` | `9f03c8587d6b` | [view](https://toolshed.g2.bx.psu.edu/view/pieterlukasse/prims_metabolomics2) |
| pieterlukasse/prims_metabolomics2 | `xcms_get_mass_eic` | `metaMS/xcms_get_mass_eic.xml` | `9f03c8587d6b` | [view](https://toolshed.g2.bx.psu.edu/view/pieterlukasse/prims_metabolomics2) |
| qfab/pynast | `pynast` | `pynast/pynast.xml` | `17b2737094ce` | [view](https://toolshed.g2.bx.psu.edu/view/qfab/pynast) |
| qfab/usearch_map_reads_to_otus | `map_reads_otu` | `usearch_map_reads_to_otu/map_reads_otu.xml` | `87603fcae838` | [view](https://toolshed.g2.bx.psu.edu/view/qfab/usearch_map_reads_to_otus) |
| qfab/usearch_uchime | `uchime` | `uchime/uchime.xml` | `fd0ab76b83f1` | [view](https://toolshed.g2.bx.psu.edu/view/qfab/usearch_uchime) |
| qfabrepo/metadegalaxy_phyloseq_abundance_factor | `phyloseq_abundance` | `phyloseq_abundance_factor.xml` | `3856a1590a11` | [view](https://toolshed.g2.bx.psu.edu/view/qfabrepo/metadegalaxy_phyloseq_abundance_factor) |
| qfabrepo/metadegalaxy_phyloseq_abundance_taxonomy | `phyloseq_taxonomy` | `phyloseq_abundance_taxonomy.xml` | `b2fafdd3533d` | [view](https://toolshed.g2.bx.psu.edu/view/qfabrepo/metadegalaxy_phyloseq_abundance_taxonomy) |
