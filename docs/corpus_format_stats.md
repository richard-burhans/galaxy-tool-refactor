...
Generated by `python -m scripts.corpus_check fmt` on 2026-06-10 over the combined corpus (github + toolshed, sha256-deduplicated), gated on validation under any vendored profile. Swept 9,374 tool documents across 7,694 repositories; 8,624 validated (any vendored profile) and were format-checked.
...
|---|---:|---:|
| github | 21 | 3,972 |
| toolshed | 7,673 | 4,652 |

## Sweep summary

| Outcome | Tools |
|---|---:|
| Parsed as `<tool>` | 9,374 |
| Unparseable XML (skipped) | 33 |
| Non-tool root (skipped) | 3,604 |
| Validated (in fmt scope) | 8,624 |
| Formatted without crashing | 8,624 |
| **Idempotent** | **8,624** |
| Non-idempotent | 0 |
| Crashed | 0 |
