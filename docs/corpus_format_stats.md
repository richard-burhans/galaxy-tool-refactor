...
Generated by `python -m scripts.corpus_check fmt` on 2026-06-14 over the combined corpus (github + toolshed, sha256-deduplicated), gated on validation under any vendored profile. Swept 9,373 tool documents across 7,693 repositories; 8,623 validated (any vendored profile) and were format-checked.
...
|---|---:|---:|
| github | 21 | 3,972 |
| toolshed | 7,672 | 4,651 |

## Sweep summary

| Outcome | Tools |
|---|---:|
| Parsed as `<tool>` | 9,373 |
| Unparseable XML (skipped) | 33 |
| Non-tool root (skipped) | 3,604 |
| Validated (in fmt scope) | 8,623 |
| Formatted without crashing | 8,623 |
| **Idempotent** | **8,623** |
| Non-idempotent | 0 |
| Crashed | 0 |
