...
Generated by `python -m scripts.corpus_check fmt` on 2026-06-12 over the combined corpus (github + toolshed, sha256-deduplicated), gated on validation under any vendored profile. Swept 9,373 tool documents across 7,693 repositories; 8,623 validated (any vendored profile) and were format-checked.
