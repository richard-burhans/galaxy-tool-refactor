...
Generated by `python -m scripts.corpus_check fmt` on 2026-06-09 over the combined corpus (github + toolshed, sha256-deduplicated), gated on validation under any vendored profile. Swept 9,358 tool documents across 7,668 repositories; 8,608 validated (any vendored profile) and were format-checked.
