...
Generated by `python -m scripts.corpus_check fmt` on 2026-09-14 over the combined corpus (github + toolshed, sha256-deduplicated), gated on validation under any vendored profile. Swept 9,476 tool documents across 7,903 repositories; 8,726 validated (any vendored profile) and were format-checked.
...
|---|---:|---:|
| github | 21 | 4,121 |
| toolshed | 7,882 | 4,605 |

## Sweep summary

| Outcome | Tools |
|---|---:|
| Parsed as `<tool>` | 9,476 |
| Unparseable XML (skipped) | 34 |
| Non-tool root (skipped) | 3,720 |
| Validated (in fmt scope) | 8,726 |
| Formatted without crashing | 8,726 |
| **Idempotent** | **8,726** |
| Non-idempotent | 0 |
| Crashed | 0 |
