...
Generated by `python -m scripts.corpus_check fmt` on 2026-06-22 over the combined corpus (github + toolshed, sha256-deduplicated), gated on validation under any vendored profile. Swept 9,389 tool documents across 7,717 repositories; 8,639 validated (any vendored profile) and were format-checked.
...
|---|---:|---:|
| github | 21 | 3,988 |
| toolshed | 7,696 | 4,651 |

## Sweep summary

| Outcome | Tools |
|---|---:|
| Parsed as `<tool>` | 9,389 |
| Unparseable XML (skipped) | 33 |
| Non-tool root (skipped) | 3,614 |
| Validated (in fmt scope) | 8,639 |
| Formatted without crashing | 8,639 |
| **Idempotent** | **8,639** |
| Non-idempotent | 0 |
| Crashed | 0 |
