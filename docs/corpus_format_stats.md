...
Generated by `python -m scripts.corpus_check fmt` on 2026-06-29 over the combined corpus (github + toolshed, sha256-deduplicated), gated on validation under any vendored profile. Swept 9,393 tool documents across 7,721 repositories; 8,643 validated (any vendored profile) and were format-checked.
...
|---|---:|---:|
| github | 21 | 3,993 |
| toolshed | 7,700 | 4,650 |

## Sweep summary

| Outcome | Tools |
|---|---:|
| Parsed as `<tool>` | 9,393 |
| Unparseable XML (skipped) | 33 |
| Non-tool root (skipped) | 3,615 |
| Validated (in fmt scope) | 8,643 |
| Formatted without crashing | 8,643 |
| **Idempotent** | **8,643** |
| Non-idempotent | 0 |
| Crashed | 0 |
