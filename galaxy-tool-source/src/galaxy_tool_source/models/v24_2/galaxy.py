...
class Help:
    ...
    This tag set should be included as the next to the last tag set, before
    citations, in the tool config. Tool help is written in
    reStructuredText. Included here is only an overview of a subset of
...
class Tool:
    ...
    `data_ref` attribute for `data_column` parameters ### Examples A normal
