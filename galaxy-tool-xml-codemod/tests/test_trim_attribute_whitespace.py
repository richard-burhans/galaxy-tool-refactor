...
def test_tool_name_whitespace_is_left_for_the_advisory() -> None:
    # The name trim moved to the GTR035.2 advisory (display-contract claim,
    # below the fixable construction bar) — the codemod leaves it.
    module = parse_module(
